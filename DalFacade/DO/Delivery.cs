...
/// <param name="DeliveryShippingType">The type of delivery, based on the Enums class.</param>
/// <param name="StartDeliveryTime">The date and time when the order was picked up by the courier.</param>
...
(
    ...
    int OrderId,
    int CourierId,
    Enums.ShippingType DeliveryShippingType,
